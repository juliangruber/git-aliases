...
alias gpum="git pull upstream main 2>/dev/null || git pull upstream master"
alias gf="git fetch"
alias gp="git push"
...
alias gc="git clone"
alias gr="git rebase"
alias grm="git rebase main 2>/dev/null || git rebase master"
alias grc="git rebase --continue"
alias grs="git rebase --skip"
alias gcp="git cherry-pick"
alias gmm="git merge main 2>/dev/null || git merge master"
